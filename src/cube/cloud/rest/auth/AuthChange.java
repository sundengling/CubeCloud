...
/**
 * Servlet implementation class AuthChange
 */
@WebServlet("/auth/change")
public class AuthChange extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean isHasAuth = true;	//是否有权限

		Role r = channel.getTenantRole(name);
		if (r.hasAuthority(Authority.parse(authCode))) {
