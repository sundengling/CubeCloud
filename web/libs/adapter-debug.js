...
if(!!navigator.platform.match(/^Mac/i)) {
  AdapterJS.WebRTCPlugin.pluginInfo.downloadLink = 'http://211.103.217.154/plugin/TemWebRTCPlugin.dmg';//'http://bit.ly/1n77hco';
}
else if(!!navigator.platform.match(/^Win/i)) {
  AdapterJS.WebRTCPlugin.pluginInfo.downloadLink = 'http://211.103.217.154/plugin/TemWebRTCPlugin.msi';//'http://bit.ly/1kkS4FN';
}
